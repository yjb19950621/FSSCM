$(function () {
    ...
    var service = fSSCM.customers.customer;
    var createModal = new abp.ModalManager(abp.appPath + 'Customers/Customer/CreateModal');
    var editModal = new abp.ModalManager(abp.appPath + 'Customers/Customer/EditModal');
